...
% Verwendete Schriftarten, kann aus meiner Sicht unterbleiben
...
\title{Seminararbeit \\ im Studiengang \\ Verwaltungsinformatik \\ Thema: \linebreak Internet der Dinge \\ - \\ Gefahr oder Chance für private Konsumenten?}
...
\section{Definition}
\glqq Internet der Dinge\grqq  
bezeichnet die Vernetzung von Gegenständen mit dem Internet, damit diese Gegenstände selbstständig über das Internet kommunizieren und so verschiedene Aufgaben für den Besitzer erledigen können. Der Anwendungsbereich erstreckt sich dabei von einer allg. Informationsversorgung über automatische Bestellungen bis hin zu Warn- und Notfallfunktionen \footcite{Gabler2015}.




\section{Zielsetzung dieser Arbeit}
\subsection{Grobe Zielsetzung}
In der vorliegenden Arbeit sollen anhand einzelner Beispiele aus dem täglichen Leben, die Chancen und Gefahren der stärkeren Vernetzung unseres Lebens herausgearbeitet werden.
Im wesentlichen werde ich mich an die im Buch \cite{Greengard2015}\footcite{Greengard2015}

\chapter{Vorteile des Internet der Dinge für Verbraucher}
\section{Smarte Netze}
\section{Heimautomation}
\chapter{Nachteile des Internets der Dinge für Verbraucher}
\section{Sicherheit}
\subsection{Ausfall-}
Ausfall des von T-Mobile verkauften Heimautomationssystems \abk{HAS}{Heimautomationssystem} wegen Serverproblemen -> Probleme die nicht in der Macht des Einzelnen stehen
